...
Generator.prototype.group = function (group, inline) {
  ...
  return group.indexOf(this._options.newline) === -1 ? '{ ' + group + ' }' : '{' + this._options.newline + indent(group) + this._options.newline + '}';
};
...
function indent(text) { return text.replace(/^/gm, this._options.indentation); }
