...
Generator.prototype.baseAndPrefixes = function (q) {
  ...
  var prefixes = '';
  // when option "allPrefixes" is an object use it as fixedPrefixes
  var fixedPrefixes = typeof this._options.allPrefixes === 'object' ? this._options.allPrefixes: {}
  for (var key in q.prefixes) {
    if (this._options.allPrefixes === true || this._usedPrefixes[key] || fixedPrefixes[key])
...
/**
 * @param options {
 *   allPrefixes: boolean | prefixList,
 *   indentation: string,
 *   newline: string
 * }
 */
